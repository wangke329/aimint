    ...
    var n = Object.assign || function (t) {
        ...
        , a = function () {
            ...
            return t.prototype.onChartReady = function (t) {
                ...
                document.getElementById('tvchart').childNodes[0].setAttribute('style','display:block;width:100%;height:100%;');}
                ,
                ...
                t.prototype._render = function () {
                    ...
                    return '<iframe id="' + this._id + '" name="' + this._id + '"  src="' + e + '"' + (this._options.autosize || this._options.fullscreen ? "" : ' width="' + this._options.width + '" height="' + this._options.height + '"') + ' frameborder="0" allowTransparency="true" scrolling="no" allowfullscreen style="display:none;"></iframe>'
                }
                ,
                t
        }()
